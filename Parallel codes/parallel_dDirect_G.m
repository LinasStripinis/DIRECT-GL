function [ret_minval, final_xatmin, history] = parallel_dDirect_G...
    (Problem, bounds, opts)
%--------------------------------------------------------------------------
% Function   : parallel_dDirect_G
...
%--------------------------------------------------------------------------
    ...
    [MV, MSS, CE, third, VAL, SS] = Alocate(bounds, SS);
...
%--------------------------------------------------------------------------
function [MV, MSS, CE, third, VAL, SS] = Alocate(bounds, SS)
%--------------------------------------------------------------------------
