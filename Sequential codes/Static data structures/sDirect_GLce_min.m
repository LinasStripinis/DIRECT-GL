function [minima, xatmin, history] = sDirect_GLce_min(Problem, bounds, opts)
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
% [minima, xatmin, history] = sDirect_GLce_min(Problem, bounds, opts)
...
if (VAL.stagnate > 0) && (abs(VAL.min_gen - VAL.fminloc) >...
    ...
    options = optimoptions('fmincon', 'StepTolerance', OPTI.TOL/1000);
